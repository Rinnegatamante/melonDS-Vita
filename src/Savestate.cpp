...
Savestate::Savestate(char* filename, bool save)
{
    ...
    if (save)
    {
        ...
        melon_fwrite(magic, 4, 1, file);
        melon_fwrite(&VersionMajor, 2, 1, file);
        melon_fwrite(&VersionMinor, 2, 1, file);
